...
<div class="edu-index-body">                                                                     \
	<div class="edu-index-pop-ups" style="margin: 0 auto;">                                      \
		<div class="edu-index-logo" style="display: flex;justify-content: center;">                                                             \
			<img  th:src="@{/v/assets/webrtc-logo-min.png}" alt="" />                                     \
		</div>                                                                                   \
		<!-- 输入直播课堂 s -->                                                                  \
		<div class="edu-index-class-input">                                                      \
			<ul>                                                                                 \
				<li><input type="text" placeholder="请输入课堂名称" value="栖霞区政务服务中心" /></li> \
				<li><input type="text" placeholder="请输入你的昵称" value="工作人员"  /></li> \
			</ul>	                                                                             \
		</div>                                                                       			 \
		<!-- 输入直播课堂 e -->                                                                  \
                                                                                                 \
