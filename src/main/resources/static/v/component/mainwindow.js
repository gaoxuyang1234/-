...
var MainView = {
  template: '\
	<div style="position: absolute; top: 0; bottom: 0; left: 0;right: 0; ">\
        <div class="edu-container">                                                                                                                                                                                          \
            ...
            <!-- 左侧固定 start -->                                                                                                                                                                                          \
                <div class="edu-left-sidebar" style="display:none;">                                                                                                                                                                               \
                ...
                <div class="edu-main" style="overflow-y: scroll">                                                                                                                                                            \
                    <div style="height: 100%;position:relative;">                                                                                                                                                                                      \
                        <!-- 互动人员 start -->                                                                                                                                                                              \
	                    <div style="position:absolute;top:35px;font-size:30px;left:10px;display:flex;flex-direction: column;align-items: center;"><span style="display:none;">正在与苗洪彬视频通话</span><button type="button" style="display:none;background-color:red;width:200px;height:40px;color:white;font-size:20px;border-radius:8px;font-weight:bold;margin-top:40px;outline:none">结束通话</button></div>                                           \
                        <div v-show="mode === \'camera\'" class="tc-member-list-container" style="height:100%">                                                                                                               \
                                                                                                                                                                                                                             \
                                <div v-for="(item, index) in members" :key="index" style="height:100%">                                                                                                                    \
                                    <!-- 互动人员图片 start -->                                                                                                                                                              \
                                    <div class="edu-member-img" :id="\'video_\'+(item.id)">                                                                                                                                    \
                                        ...
                                        <video :id="\'v_\'+(item.id)" style=" margin: 0 auto; width: 55%; height: 100%;margin-left:45%" autoplay playsinline></video>\
                                    </div>                                                                                                                                                                                   \
                                    <!-- 互动人员图片 end -->                                                                                                                                                                \
                                    <!-- 互动信息 start -->                                                                                                                                                                  \
                        ...
                        <!-- 互动人员 end -->                                                                                                                                                                                \
						  <!-- 内容快 start -->                                                                                                                                                                                \
					      <div class="edu-area-main" style="position:absolute;bottom:0px;width:45%;">                                                                                                                                                                          \
					          <!--tab1 摄像头 Start -->                                                                                                                                                                        \
  ...
  mounted: function () {
    ...
    if (!query) {
      alert("请先登录!");
    	...
    	console.log(query.roomCreator);
      this.userID = query.userID;
      this.selfRole = '栖霞区政务服务中心'
      this.canDraw = true;
      this.isRoomCreator = true;
      this.courseName = '栖霞区政务服务中心';
  ...
  methods: {
    ...
    actionCreateRoom: function (query) {
      ...
      var self = this;
      console.log(localStorage.getItem('course_info'))
