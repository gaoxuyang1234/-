var WebRTCRoom = (function () {
  //var serverDomain = 'http://localhost:8081/weapp/webrtc_room',
  var serverDomain = 'https://wx.zhengebang.com/weapp/webrtc_room',
    requestNum = 0,
    heart = '', // 判断心跳变量
    heartBeatReq = null,
    requestSeq = 0, // 请求id
  ...
  function createRoom(userID, nickName, roomInfo, success, fail) {
    var toUser = window.parent.document.getElementById("toUser").value;
    var aId = window.parent.document.getElementById("aId").value;
      var accnodeId = window.parent.document.getElementById("accnodeId").value;
      var accId = window.parent.document.getElementById("accId").value;
      if(!toUser)
      {
